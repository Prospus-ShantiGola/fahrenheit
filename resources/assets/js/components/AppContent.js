                    ...
                    <div className="icon-area">
                        <div className="row">
                            ...
                            <ul className="list-inline left-icon-list">
                                ...
                                <li ><a href="javascript:location.reload();" className= "add-new-adcalc "><img src="public/images/icon_1.png" alt="" className="toplinks" title="New project" /></a></li>
