...
class UserReportsController extends Controller
{
    ...
    {
        $userReports = UserReport::with('user')->paginate(25);
       // dd($userReports);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('user_reports.user_report.index')
                             ->with('success_message', 'User Report was successfully added!');
    ...
    public function update($id, Request $request)
    {
        try {
            ...
            return redirect()->route('user_reports.user_report.index')
                             ->with('success_message', 'User Report was successfully updated!');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('user_reports.user_report.index')
                             ->with('success_message', 'User Report was successfully deleted!');
